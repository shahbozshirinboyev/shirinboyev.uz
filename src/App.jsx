...
function App() {
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 container mx-auto lg:px-18 xl:px-32 items-start">
          ...
          <div className="lg:col-span-2">
            <div className="px-4">
              ...
              <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Similique hic earum doloremque molestiae, quisquam quia
                deleniti! Repellat nesciunt tenetur neque?
              </p>
            </div>
      ...
      {/* Work */}
      <div className="min-h-[500px] flex justify-start items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 container mx-auto lg:px-18 xl:px-32 items-start">
          <div className="w-full">
            <span className="text-6xl">01</span>
            <h2 className="text-2xl py-2">Frontend Project</h2>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit
              magni porro, nobis dignissimos reprehenderit totam.
            </p>
            <div className="flex gap-3 py-2">
              <span className="border rounded-2xl px-2 py-1 text-[12px]">
                Html 5
              </span>
              <span className="border rounded-2xl px-2 py-1 text-[12px]">
                CSS 3
          ...
          <div className="w-full">
            <div className="w-full">
              <img
                ...
                src="https://picsum.photos/500/600/?blur"
                alt=""
              />
            </div>
