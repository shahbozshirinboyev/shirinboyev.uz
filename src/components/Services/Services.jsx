...
function Services() {
  ...
  return (
    <div id="services" className="c_container">
      ...
      <div className="grid grid-cols-1 laptop:grid-cols-2 gap-14">
        {services.items.map((item, index) => (
          <div key={index} className="group">
            <a href={item.link} target="_blank">
              <div className="flex justify-between items-center">
                <span className="text-5xl font-extrabold number__font-services group-hover:text-green-500">{item.number}</span>
              ...
              <p className="mt-12 text-md laptop:text-lg opacity-50">{item.description}</p>
