...
function Services() {
  return (
    <div className='container mx-auto px-2 tablet:px-0 grid grid-cols-1 laptop:grid-cols-2 gap-12 my-12'>
      <div className=''>
        ...
        <h2 className='text-5xl font-extrabold'>Web Development</h2>
