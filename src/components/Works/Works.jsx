...
const projects = [
  {
    ...
    description:
      "Personal portfolio website built with React and Tailwind CSS. Fully responsive and includes a dark mode switcher.",
    tools: ["React", "TailwindCSS", "Framer Motion"],
    image:
      "https://cdn.dribbble.com/userupload/32202836/file/original-ed57e24965cae881f7bc51b0eb5f842b.jpg?resize=1200x900&vertical=center",
  },
  {
    id: 2,
    number: "02",
    title: "E-commerce UI",
    description:
      "A modern and minimal e-commerce frontend built with Next.js and styled-components. Product cards, filtering, and cart system UI.",
    tools: ["Next.js", "Styled-Components", "JavaScript"],
    image:
      "https://cdn.dribbble.com/userupload/32202836/file/original-ed57e24965cae881f7bc51b0eb5f842b.jpg?resize=1200x900&vertical=center",
  },
  {
    ...
    description:
      "A beautiful and clean blog layout created using HTML and CSS only. Includes featured post section and tag filtering.",
  ...
  },
  {
    ...
    description:
      "A professional admin dashboard with charts, tables, and user management interface. Designed with responsiveness in mind.",
    tools: ["React", "Chart.js", "TailwindCSS"],
    image:
      "https://cdn.dribbble.com/userupload/32202836/file/original-ed57e24965cae881f7bc51b0eb5f842b.jpg?resize=1200x900&vertical=center",
  },
  {
    ...
    description:
      "A simple and effective task management UI with drag-and-drop functionality. Inspired by Trello, built with React DnD.",
    tools: ["React", "React DnD", "CSS Modules"],
    image:
      "https://cdn.dribbble.com/userupload/32202836/file/original-ed57e24965cae881f7bc51b0eb5f842b.jpg?resize=1200x900&vertical=center",
  },
];
  ...
  return (
    ...
    >
      <div className="border border-green-200 bg-green-50/70 backdrop-blur-sm p-2 mb-4 rounded-sm">
        <h2 className="font-bold text-green-500">Works</h2>
      </div>
