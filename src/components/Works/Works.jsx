...
function Works() {
  return (
    <div className='container mx-auto px-4 tablet:px-0 my-12 border border-red-500'>
      ...
      <div className="grid grid-cols-1 laptop:grid-cols-2 gap-3 laptop:gap-12">
        ...
        <div className='border order-2 laptop:order-1'>
          ...
          <div className='flex gap-2 justify-start'>
            ...
            <button className='btn btn-circle'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
      ...
      <div className='flex items-center justify-end gap-4 mt-4 border border-green-500'>
