        ...
        <div className="flex flex-col laptop:flex-row gap-4 ">
          <div className="w-full order-2 laptop:order-1">
            ...
            <div className="flex gap-2 mt-5 justify-center laptop:justify-start">
              <a href="https://shirinboyev-cv.netlify.app/file/shirinboyev_shahboz_cv_ru.pdf" target="_blank" className="btn rounded-full flex gap-2 border border-green-200 bg-green-50 dark:bg-green-50/10 dark:border-green-200/10 text-green-500 hover:bg-green-500 hover:text-white hover:border-transparent">
